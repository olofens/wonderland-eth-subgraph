...
export class USTCauldron__accrueInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class USTCauldron__borrowResult {
  value0: BigInt;
  value1: BigInt;
...
export class USTCauldron__totalBorrowResult {
  value0: BigInt;
  value1: BigInt;
...
export class USTCauldron__updateExchangeRateResult {
  value0: boolean;
  value1: BigInt;
...
export class USTCauldron extends ethereum.SmartContract {
  static bind(address: Address): USTCauldron {
    return new USTCauldron("USTCauldron", address);
  }
  ...
  accrueInfo(): USTCauldron__accrueInfoResult {
    let result = super.call(
      "accrueInfo",
    ...
    return new USTCauldron__accrueInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_accrueInfo(): ethereum.CallResult<USTCauldron__accrueInfoResult> {
    let result = super.tryCall(
      "accrueInfo",
      "accrueInfo():(uint64,uint128,uint64)",
      []
    ...
    return ethereum.CallResult.fromValue(
      new USTCauldron__accrueInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  borrow(to: Address, amount: BigInt): USTCauldron__borrowResult {
    let result = super.call(
      "borrow",
    ...
    return new USTCauldron__borrowResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_borrow(
    to: Address,
    amount: BigInt
  ): ethereum.CallResult<USTCauldron__borrowResult> {
    let result = super.tryCall(
      "borrow",
      "borrow(address,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new USTCauldron__borrowResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  totalBorrow(): USTCauldron__totalBorrowResult {
    let result = super.call(
      "totalBorrow",
    ...
    return new USTCauldron__totalBorrowResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_totalBorrow(): ethereum.CallResult<USTCauldron__totalBorrowResult> {
    let result = super.tryCall(
      "totalBorrow",
      "totalBorrow():(uint128,uint128)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new USTCauldron__totalBorrowResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  updateExchangeRate(): USTCauldron__updateExchangeRateResult {
    let result = super.call(
      "updateExchangeRate",
    ...
    return new USTCauldron__updateExchangeRateResult(
      result[0].toBoolean(),
      result[1].toBigInt()
    );
  }
  ...
  try_updateExchangeRate(): ethereum.CallResult<
    USTCauldron__updateExchangeRateResult
  > {
    let result = super.tryCall(
      "updateExchangeRate",
      "updateExchangeRate():(bool,uint256)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new USTCauldron__updateExchangeRateResult(
        value[0].toBoolean(),
        value[1].toBigInt()
      )
    );
