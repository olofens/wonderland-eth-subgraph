...
export class Bentobox__strategyDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class Bentobox__totalsResult {
  value0: BigInt;
  value1: BigInt;
...
export class Bentobox__withdrawResult {
  value0: BigInt;
  value1: BigInt;
...
export class Bentobox extends ethereum.SmartContract {
  ...
  strategyData(param0: Address): Bentobox__strategyDataResult {
    let result = super.call(
      "strategyData",
    ...
    return new Bentobox__strategyDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_strategyData(
    param0: Address
  ): ethereum.CallResult<Bentobox__strategyDataResult> {
    let result = super.tryCall(
      "strategyData",
      "strategyData(address):(uint64,uint64,uint128)",
      [ethereum.Value.fromAddress(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new Bentobox__strategyDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  totals(param0: Address): Bentobox__totalsResult {
    let result = super.call("totals", "totals(address):(uint128,uint128)", [
      ethereum.Value.fromAddress(param0)
    ]);

    return new Bentobox__totalsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_totals(param0: Address): ethereum.CallResult<Bentobox__totalsResult> {
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Bentobox__totalsResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  withdraw(
    ...
    return new Bentobox__withdrawResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_withdraw(
    ...
    amount: BigInt,
    share: BigInt
  ): ethereum.CallResult<Bentobox__withdrawResult> {
    let result = super.tryCall(
      "withdraw",
      "withdraw(address,address,address,uint256,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Bentobox__withdrawResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
}
